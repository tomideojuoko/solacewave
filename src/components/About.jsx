      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative" data-anim>
            <div className="bg-sand/40 rounded-3xl p-8 border border-sand space-y-4">
          ...
          <div className="space-y-6" data-anim style={{ transitionDelay: '0.15s' }}>
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight text-balance text-brown">
              Therapy that holds your <em className="not-italic text-terra">whole</em> story
            </h2>
            <p className="text-muted text-lg leading-relaxed">
              Growing up between cultures means learning to exist in spaces that were never designed for you. The pressure of immigration, the weight of generational expectations, the silent longing for a home that exists somewhere between two worlds. These experiences are real, they are valid, and they deserve real care.
            </p>
            <p className="text-muted text-lg leading-relaxed">
